...
[Opt1,ind1] = max(Data_low1.cases_per_booster_target(:,plot_year_ind));
[Opt2,ind2] = max(Data_low3.cases_per_booster_target(:,plot_year_ind));
[Opt3,ind3] = max(Data_low6.cases_per_booster_target(:,plot_year_ind));
...
[~, max_pos] = max(Data_low1.cases_per_booster_target(:,plot_year_ind));

plot(t0_list,Data_low3.cases_per_booster_target(:,plot_year_ind),'k-.','DisplayName','3-month');
[~, max_pos1] = max(Data_low3.cases_per_booster_target(:,plot_year_ind));
% 
plot(t0_list,Data_low6.cases_per_booster_target(:,plot_year_ind),'k:','DisplayName','6-month');
[~, max_pos2] = max(Data_low6.cases_per_booster_target(:,plot_year_ind));

%plot(t0_list,Data_low9.cases_per_booster_target(:,plot_year_ind),'k-*','DisplayName','9-month');
%[~, max_pos3] = max(Data_low9.cases_per_booster_target(:,plot_year_ind));
...
scatter(t0_list(max_pos),Data_low1.cases_per_booster_target(max_pos,plot_year_ind),350,'d','filled','magenta');
scatter(t0_list(max_pos1),Data_low3.cases_per_booster_target(max_pos1,plot_year_ind),350,'d','filled','magenta');
scatter(t0_list(max_pos2),Data_low6.cases_per_booster_target(max_pos2,plot_year_ind),350,'d','filled','magenta');
%scatter(t0_list(max_pos3),Data_low9.cases_per_booster_target(max_pos3,plot_year_ind),350,'d','filled','magenta');
...
save_string = strcat('fig6_nanoro','A','.svg');
saveas(gcf,save_string);
%% Plotting seasonal profile
% h = figure_setups_3;
% hold on
% ind = 1:10:length(t);
% yyaxis left
% p1 = plot(t/30,IM,'-^','MarkerIndices',ind,'DisplayName','Mosquitoes','MarkerSize',20);
% ylim([0 0.15*10^8])
% yticks([0 0.05*10^8 0.1*10^8 0.15*10^8]);
% ylabel('Infected Mosquitoes')
% yyaxis right
% p2 = plot(t/30,EIR_tot,'-o','MarkerIndices',ind,'DisplayName','EIR','MarkerSize',20);
% ylabel('EIR');
% ylim([0 120])
...
% save_string = strcat('fig6_nanoro','B','.svg');
% saveas(gcf,save_string);
%%
% h = figure_setups_3;
% yyaxis left
...
% % plot(t0_list,Data_verylow3.cases_per_booster_target(:,plot_year_ind),':*',...
% %     'DisplayName','v. low vac count','MarkerIndices',ind,'MarkerSize',15);
% plot(t0_list,Data_high3.cases_per_booster_target(:,plot_year_ind),'-^',...
%     'DisplayName','low vac count','MarkerIndices',ind,'MarkerSize',20);
% plot(t0_list,Data_high3.cases_per_booster_target(:,plot_year_ind),'-o',...
...
% save_string = strcat('fig6_nanoro','C','.svg');
% saveas(gcf,save_string);
% 
...
[~, max_pos] = max(Data_low1.death_per_booster_target(:,plot_year_ind));

plot(t0_list,Data_low3.death_per_booster_target(:,plot_year_ind),'k-.','DisplayName','3-month');
[~, max_pos1] = max(Data_low3.death_per_booster_target(:,plot_year_ind));

plot(t0_list,Data_low6.death_per_booster_target(:,plot_year_ind),'k:','DisplayName','6-month');
[~, max_pos2] = max(Data_low6.death_per_booster_target(:,plot_year_ind));
...
scatter(t0_list(max_pos),Data_low1.death_per_booster_target(max_pos,plot_year_ind),300,'d','filled','magenta');
scatter(t0_list(max_pos1),Data_low3.death_per_booster_target(max_pos1,plot_year_ind),300,'d','filled','magenta');
scatter(t0_list(max_pos2),Data_low6.death_per_booster_target(max_pos2,plot_year_ind),300,'d','filled','magenta');
...
% [~, max_pos] = max(Data_low1.death_per_booster_full(:,plot_year_ind));
% 
% plot(t0_list,Data_low3.death_per_booster_full(:,plot_year_ind),'k-.','DisplayName','3-month');
% [~, max_pos1] = max(Data_low3.death_per_booster_full(:,plot_year_ind));
% 
% plot(t0_list,Data_low6.death_per_booster_full(:,plot_year_ind),'k:','DisplayName','6-month');
% [~, max_pos2] = max(Data_low6.death_per_booster_full(:,plot_year_ind));
% 
...
% 
% scatter(t0_list(max_pos),Data_low1.death_per_booster_full(max_pos,plot_year_ind),300,'d','filled','magenta');
% scatter(t0_list(max_pos1),Data_low3.death_per_booster_full(max_pos1,plot_year_ind),300,'d','filled','magenta');
% scatter(t0_list(max_pos2),Data_low6.death_per_booster_full(max_pos2,plot_year_ind),300,'d','filled','magenta');
...
[~, max_pos] = max(Data_low1.cases_per_booster_full(:,plot_year_ind));

plot(t0_list,Data_low3.cases_per_booster_full(:,plot_year_ind),'k-.','DisplayName','3-month');
[~, max_pos1] = max(Data_low3.cases_per_booster_full(:,plot_year_ind));

plot(t0_list,Data_low6.cases_per_booster_full(:,plot_year_ind),'k:','DisplayName','6-month');
[~, max_pos2] = max(Data_low6.cases_per_booster_full(:,plot_year_ind));
...
scatter(t0_list(max_pos),Data_low1.cases_per_booster_full(max_pos,plot_year_ind),300,'d','filled','magenta');
scatter(t0_list(max_pos1),Data_low3.cases_per_booster_full(max_pos1,plot_year_ind),300,'d','filled','magenta');
scatter(t0_list(max_pos2),Data_low6.cases_per_booster_full(max_pos2,plot_year_ind),300,'d','filled','magenta');