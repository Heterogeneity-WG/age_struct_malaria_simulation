...
if immunity_feedback == -1 % betaM = 0.03
    P.phif0 = 0.230971153687268; % value at zero
    P.phif1 = 0.230971153687268; % value at L (function saturates to this value)
...
elseif immunity_feedback == 0 % betaM = 0.5
    % average populational sigmoids f0 = f1 = average
    P.phif0 = 0.885447066345765; % value at zero
    P.phif1 = 0.885447066345765; % value at L (function saturates to this value)
    P.rhof0 = 0.109344013288269; % value at zero
    P.rhof1 = 0.109344013288269; % value at L (function saturates to this value
    P.psif0 = 0.1005924569216076; % value at zero
    P.psif1 = 0.100592456921607; % value at L (function saturates to this value)
    P.betaM = 0.5;
