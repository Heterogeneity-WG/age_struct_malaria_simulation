...
vac_period = 1; vac_count = 1.2*10^5; booster_count = 0.1*10^4;
nyears = 10;
for iyear = 1:nyears
    P.v0 = vac_count/365; P.vb0 = booster_count/(vac_period*30); Malaria_parameters_transform_vac;
    tfinal_conti = vac_period*30;
    ...
    P.vb0 = 0; Malaria_parameters_transform_vac;
    tfinal_conti = 365-vac_period*30;
    SH0 = SHv(:,end); EH0 = EHv(:,end); DH0 = DHv(:,end); AH0 = AHv(:,end); VH0 = VHv(:,end); UH0 = UHv(:,end);
    Cac0 = Cacv(:,end); Cm0 = Cmv(:,end); Ctot0 = Ctotv(:,end);
    SHb0 = SHb(:,end); EHb0 = EHb(:,end); DHb0 = DHb(:,end); AHb0 = AHb(:,end); VHb0 = VHb(:,end); UHb0 = UHb(:,end);
    Cacb0 = Cacb(:,end); Cmb0 = Cmb(:,end); Ctotb0 = Ctotb(:,end);
